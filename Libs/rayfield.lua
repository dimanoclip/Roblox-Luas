--https://raw.githubusercontent.com/Dimanoname/Roblox-Luas/main/Libs/rayfield.lua
--[[
...
function Hide()
	Debounce = true
	RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping RCTRL", Duration = 7})
