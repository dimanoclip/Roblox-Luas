...
local w = library:CreateWindow("SPS script by Noname")
local b = w:CreateFolder("AutoFarm (Detectable)")
local f = w:CreateFolder("AutoFarm (Undetectable)")
local e = w:CreateFolder("Misc func.")
local u = w:CreateFolder("info")
...
--Credits
u:Button("Noname#2971",function()
    setclipboard("Noname#2971")
end)
 
u:Button("Discord Server",function()
    setclipboard("https://discord.gg/GT66A4egBG")
end)
